<?php $__env->startSection('content'); ?>
    <!-- Masthead-->
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase"> <?php echo e($about->title); ?> </h2>
                    <h3 class="section-subheading text-muted"> <?php echo e($about->description); ?> </h3>
                </div>
                    ...
                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4">
                            <div class="team-member">
                                <img class="mx-auto rounded-circle" src="/images/<?php echo e($member->image); ?>" alt="" />
                                <h4><?php echo e($member->title); ?></h4>
                                <p class="text-muted"><?php echo e($member->description); ?></p>
                                <em>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase"><?php echo e($contact->title); ?></h2>
                ...
                <form method="POST" id="contactForm" action="<?php echo e(route('save_message')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-md-0">
                                <input placeholder="MOBILE*" id="phone" type="text" class="form-control <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="message" name="message" placeholder="Message *" required autocomplete="message"></textarea>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/amicirev/public_html/resources/views/home/index.blade.php ENDPATH**/ ?>