<?php $__env->startSection('content'); ?>
	<h1 class="mt-4">Add Administrator
	</h1>
	
	<form method="POST" id="contentForm" action="<?php echo e(route('admin_user_save')); ?>" >
		<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/amicirev/public_html/resources/views/admin/users/add.blade.php ENDPATH**/ ?>