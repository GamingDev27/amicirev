...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
	...
	<head>
		...
		<script src="<?php echo e(asset('js/vendor/jquery.min.js')); ?>" defer></script>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="padding:0px !important;">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/logo.png" style="width: 300px;height: 80px;" alt="ARC Logo" /></a>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <?php else: ?>
                                        <a class="dropdown-item" href="<?php echo e(route('admin_dashboard')); ?>">
...
<?php /**PATH /home2/amicirev/public_html/resources/views/layouts/main.blade.php ENDPATH**/ ?>