																	...
																	<?php if(isset($albums[$class->id])): ?>
																		...
																		<div class="container-fluid p-0" >
																			<ul class="list-unstyled video-list-thumbs row  flex-row flex-nowrap overflow-auto m-0 p-1" style="background:white;border:solid 1px #212529;border-bottom:solid 4px #212529;">
																				<?php if(isset($albums[$class->id]["body"]) && isset($albums[$class->id]["body"]["data"]) && count($albums[$class->id]["body"]["data"])): ?>
																					<?php $__currentLoopData = $albums[$class->id]["body"]["data"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																						<li class="col-lg-3 col-sm-4 col-xs-6 col-6 p-0">
																							<a onclick="playVid('<?php echo e($class->id); ?>','<?php echo e(str_replace('/videos/','',$video['uri'])); ?>');" title="<?php echo e($video['name']); ?>" >
																								<?php
																									$link = "";
																								...
																								?>
																								<img src="<?php echo e($link); ?>" alt="Barca" class="img-responsive" width="100%" />
																								<h2><?php echo e($video['name']); ?></h2>
																								<i class="glyphicon-play-circle fa fa-play-circle"></i>
																								<span class="duration"><?php echo e(gmdate("H:i:s",$video['duration'])); ?></span>
																							</a>
																						</li>
																					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																				<?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('bc1523e0-8d28-4f5f-8c7a-3b4010d18ca7')): $__env->markAsRenderedOnce('bc1523e0-8d28-4f5f-8c7a-3b4010d18ca7'); ?>
	<?php $__env->startPush('scripts'); ?>
		...
		<script>
			...
			function playVid(classid,videoid){
				jQuery('#video_'+classid).html();
				if(video01Player != null)
					video01Player.destroy();
				video01Player = new Vimeo.Player('video_'+classid, {
					id: videoid
				});
				console.log('playing'+classid+'-'+videoid);
			}
		</script>
	<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/amicirev/public_html/resources/views/student/portal/showv2.blade.php ENDPATH**/ ?>