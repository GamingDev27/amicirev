...
unset($__errorArgs, $__bag); ?>" name="salutation" value="<?php echo e(old('salutation')); ?>" required autocomplete="salutation" autofocus >
						<option value=""></option>
...
unset($__errorArgs, $__bag); ?>" name="license" value="<?php echo e(old('license')); ?>" required autocomplete="license" >
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group">
					<input placeholder="Title*" id="description" type="text" class="form-control <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="accomplishments" name="accomplishments" placeholder="Accomplishments *" ></textarea>
					</div>
...
<?php if (! $__env->hasRenderedOnce('0505b9c6-5e92-4d79-9344-cc59e0ad38bb')): $__env->markAsRenderedOnce('0505b9c6-5e92-4d79-9344-cc59e0ad38bb'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/amicirev/public_html/resources/views/admin/coaches/add.blade.php ENDPATH**/ ?>