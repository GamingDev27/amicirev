	...
	<form method="POST" id="contentForm" action="{{ route('admin_course_save') }}" >
		...
		<div class="row align-items-stretch mb-5">
			...
			<div class="form-group">
				...
				<div class="form-group">
					<input placeholder="Code*" id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code') }}" required autocomplete="code" autofocus>
					@error('code')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
