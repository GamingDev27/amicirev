            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="registration-frm" novalidate>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-2 col-form-label text-md-right">{{ __('Password')
                                }}</label>
                            ...
                            <label for="password-confirm"
                                class="col-md-2 col-form-label text-md-right align-self-center">{{ __('Confirm')
                                }}</label>
                        ...
                        <hr />
                        <div class="form-group row">
                            <label for="first_name" class="col-md-2 col-form-label text-md-right">{{ __('First Name')
                                }}</label>
                            <div class="col-md-4">
                            ...
                            <label for="last_name" class="col-md-2 col-form-label text-md-right align-self-center">{{
                                __('Last Name') }}</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="birthdate" class="col-md-2 col-form-label text-md-right">{{ __('Birthdate')
                                }}</label>
                            <div class="col-md-4">
                            ...
                            <label for="sex" class="col-md-2 col-form-label text-md-right align-self-center">{{
                                __('Gender') }}</label>
                            <div class="col-md-4  align-self-center">

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" required name="sex" id="sexM"
                                        value="M">
                                    <label class="form-check-label" for="sexM"> MALE </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" required name="sex" id="sexF"
                                        value="F">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="school_name" style="display:none;" type="text"
                                    class="form-control @error('school_name') is-invalid @enderror" name="school_name"
                                    value="{{ old('school_name') }}" autocomplete="school_name">
                            ...
                            <label for="year_graduated" class="col-md-2 col-form-label text-md-right">{{ __('Graduated')
                                }}</label>
                            <div class="col-md-4">
                                <input id="year_graduated" type="number" min="2000" max="{{date('Y')}}" step="1"
                                    class="form-control @error('year_graduated') is-invalid @enderror"
                                    name="year_graduated" value="{{ old('year_graduated') }}" required
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-2 col-form-label text-md-right">{{ __('Province')
                                }}</label>
                            <div class="col-md-4">
                                <select id="province_id" onchange="setProvince(this);"
                                    class="form-control @error('province_id') is-invalid @enderror" name="province_id"
                            ...
                            <div class="col-md-4">
                                <select id="city_id" onchange="setCity(this);"
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-2 col-form-label text-md-right">{{ __('Barangay')
                                }}</label>
                            <div class="col-md-4">
                                <select id="barangay_id" class="form-control @error('barangay_id') is-invalid @enderror"
                                    name="barangay_id" value="{{ old('barangay_id') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="house_lot" class="col-md-2 col-form-label text-md-right">{{ __('House No.')
                                }}</label>
                            <div class="col-md-4">
                                <input id="house_lot" type="text"
                                    class="form-control @error('house_lot') is-invalid @enderror" name="house_lot"
                                    value="{{ old('house_lot') }}" autocomplete="house_lot">
                                @error('house_lot')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <label for="mobile" class="col-md-2 col-form-label text-md-right">{{ __('Mobile No')
                                }}</label>
                            <div class="col-md-4">
