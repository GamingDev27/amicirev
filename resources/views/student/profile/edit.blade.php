		...
		<div class="row mb-4">
			...
			<div class="col-12 col-lg-9">
				...
				<div class="form-group row p-3">
					...
					name="use_google2fa">
					<label for="use_google2fa" class="col-form-label text-light col-10 col-lg-8 text-md-left py-0">Use
						Google QR Image as my primary login verification. <strong>(Do not forget to register your QR
							Code first before enabling this!)</strong></label>
				</div>
				@endisset
